...
import me.clip.placeholderapi.common.expansion.Cacheable;
import me.clip.placeholderapi.common.expansion.Cleanable;
...
public class PlaceholderListener implements Listener {
    ...
    public PlaceholderListener(PlaceholderAPIBukkitPlugin instance) {
        plugin = instance;
    ...
    public void onExpansionUnregister(ExpansionUnregisterEvent event) {
        ...
        if (plugin.getExpansionCloud() != null) {
            CloudExpansion ex = ExpansionCloudManager.getCloudExpansion(event.getExpansion().getName());
    ...
    public void onQuit(PlayerQuitEvent e) {
        ...
        for (PlaceholderExpansion ex : expansions) {
            if (ex instanceof Cleanable) {
                ((Cleanable) ex).cleanup((PAPIPlayer) e.getPlayer());
            }
        }
    }
}
