...
import me.clip.placeholderapi.common.expansion.Relational;
...
public class PlaceholderAPI {
     ...
     */
    public static List<String> setBracketPlaceholders(OfflinePAPIPlayer p, List<String> text) {
     ...
     *
     * @param p    PAPIPlayer to parse the placeholders for
     * @param text text to parse the placeholder values in
     * @return modified list with all placeholders set to the corresponding values
     */
    public static List<String> setPlaceholders(OfflinePAPIPlayer p, List<String> text) {
     ...
     * @return modified list with all placeholders set to the corresponding values
     */
    public static List<String> setPlaceholders(OfflinePAPIPlayer p, List<String> text, Pattern pattern) {
        if (text == null) {
            return null;
        }
     ...
     * {<placeholder>} when set with this method
     *
     * @param player PAPIPlayer to parse the placeholders for
     * @param text   text to parse the placeholder values to
     * @return modified text with all placeholders set to the corresponding values
     */
    public static String setBracketPlaceholders(OfflinePAPIPlayer player, String text) {
     ...
     */
    public static String setPlaceholders(OfflinePAPIPlayer player, String text) {
     ...
     * @return text with all placeholders set to the corresponding values
     */
    public static String setPlaceholders(OfflinePAPIPlayer player, String text, Pattern placeholderPattern) {
        if (text == null) {
            return null;
        }
     ...
     *
     * @param one  PAPIPlayer to compare
     * @param two  PAPIPlayer to compare
     * @param text text to parse the placeholder values to
     * @return text with all relational placeholders set to the corresponding values
     */
    public static List<String> setRelationalPlaceholders(PAPIPlayer one, PAPIPlayer two, List<String> text) {
        if (text == null) {
            return null;
        }
     ...
     * @return text with all relational placeholders set to the corresponding values
     */
    public static String setRelationalPlaceholders(PAPIPlayer one, PAPIPlayer two, String text) {
        if (text == null) {
            return null;
        }
    ...
    public static boolean registerExpansion(PlaceholderExpansion ex) {
        return plugin.registerExpansion(ex);
    }

    public static boolean unregisterExpansion(PlaceholderExpansion ex) {
        return plugin.unregisterExpansion(ex);
    }
    ...
    public static String setPlaceholders(PAPIPlayer p, String text) {
        return setPlaceholders(p, text, PLACEHOLDER_PATTERN);
    }

    public static List<String> setPlaceholders(PAPIPlayer p, List<String> text) {
        return setPlaceholders(p, text, PLACEHOLDER_PATTERN);
    }

    public static String setBracketPlaceholders(PAPIPlayer p, String text) {
        return setPlaceholders(p, text, BRACKET_PLACEHOLDER_PATTERN);
    }

    public static List<String> setBracketPlaceholders(PAPIPlayer p, List<String> text) {
        return setPlaceholders(p, text, BRACKET_PLACEHOLDER_PATTERN);
    }
}
