...
public abstract class PlaceholderHook {
     ...
     *
     * @param p      {@link OfflinePAPIPlayer} to request the placeholder value for, null if not needed for a
     *               player
     ...
     *
     * @param p      {@link PAPIPlayer} to request the placeholder value for, null if not needed for a player
     * @param params String passed to the hook to determine what value to return
     * @return value for the requested player and params
     */
    public String onPlaceholderRequest(PAPIPlayer p, String params) {
        return null;
    }
}