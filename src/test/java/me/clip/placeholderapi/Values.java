...
public interface Values {
  ...
  String LARGE_TEXT =
      "My name is %player_name% and my location is (%player_x%, %player_y%, %player_z%), this placeholder is invalid %server_name%";

  ImmutableMap<String, PlaceholderHook> PLACEHOLDERS =
      ImmutableMap.<String, PlaceholderHook>builder()
  ...
  Replacer TESTS_REPLACER =
      new Replacer() {
        private final Set<Character> COLOR_CODES =
            ImmutableSet.of(
        ...
        public @NotNull String apply(
            ...
            final @NotNull Function<String, @Nullable PlaceholderHook> lookup) {
          char[] chars = text.toCharArray();
          StringBuilder builder = new StringBuilder(chars.length);

          // This won't cause memory leaks. It's inside a method. And we want to use setLength
          // instead of
          // creating a new string builder to use the maximum capacity and avoid initializing new
          // objects.
          ...
          //   Stage 0: No closures detected, or the detected identifier is invalid. We're going
          // forward while appending the characters normally.
            ...
            if (ch == closure.head || ch == closure.tail) {
              ...
              if (stage == 2) {
                ...
                continue;
                  ...
                  == 1) { // If it just started | Double closures | If it's still hasn't detected
                          // the indentifier, reset.
