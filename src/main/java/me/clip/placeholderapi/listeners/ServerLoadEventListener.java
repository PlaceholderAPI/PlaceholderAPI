...
public final class ServerLoadEventListener implements Listener {
   ...
   *
   * <p>The goal of the method is to register all the expansions as soon as possible especially
   * before players can join
   *
   * <p>This will ensure no issues with expansions and hooks.
   *
