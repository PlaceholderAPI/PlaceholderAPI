...
public final class PlaceholderAPI {
  ...
  @Deprecated private static final Pattern PLACEHOLDER_PATTERN = Pattern.compile("[%]([^%]+)[%]");

  @Deprecated
  private static final Pattern BRACKET_PLACEHOLDER_PATTERN = Pattern.compile("[{]([^{}]+)[}]");

  @Deprecated
  private static final Pattern RELATIONAL_PLACEHOLDER_PATTERN =
      Pattern.compile("[%](rel_)([^%]+)[%]");
  ...
  /**
   * Translates all placeholders into their corresponding values. <br>
   * The pattern of a valid placeholder is {@literal %<identifier>_<params>%}.
   *
  ...
  public static String setPlaceholders(
      @Nullable final OfflinePlayer player, @NotNull final String text) {
  ...
  public static List<String> setPlaceholders(
      @Nullable final OfflinePlayer player, @NotNull final List<@NotNull String> text) {
   ...
   */
  @NotNull
  public static String setBracketPlaceholders(
      @Nullable final OfflinePlayer player, @NotNull final String text) {
  ...
  public static List<String> setBracketPlaceholders(
      @Nullable final OfflinePlayer player, @NotNull final List<@NotNull String> text) {
    return text.stream()
        .map(line -> setBracketPlaceholders(player, line))
   ...
   */
  public static boolean registerPlaceholderHook(
      @NotNull final String identifier, @NotNull final PlaceholderHook placeholderHook) {
    return PLACEHOLDERS.putIfAbsent(identifier.toLowerCase(), placeholderHook) == null;
  }

  public static boolean registerPlaceholderHook(
      @NotNull final Plugin plugin, @NotNull final PlaceholderHook placeholderHook) {
  ...
  /**
   * Translates all placeholders into their corresponding values. <br>
   * You set the pattern yourself through this method.
   *
   * @param player Player to parse the placeholders against
   * @param text Text to set the placeholder values in
   * @param pattern The pattern to match placeholders to. Capture group 1 must contain an underscore
   *     separating the identifier from the params
  ...
  public static Set<PlaceholderExpansion> getExpansions() {
    Set<PlaceholderExpansion> set =
        getPlaceholders().values().stream()
            .filter(PlaceholderExpansion.class::isInstance)
            .map(PlaceholderExpansion.class::cast)
  ...
  @Deprecated
  public static List<String> setPlaceholders(
      OfflinePlayer player, List<String> text, Pattern pattern) {
   ...
   * <br>
   * The pattern of a valid placeholder is {@literal %rel_<identifier>_<param>%}.
   *
   ...
   * Translate placeholders in the provided list based on the relation of the two provided players.
   * <br>
   * The pattern of a valid placeholder is {@literal %rel_<identifier>_<params>%}.
   *
  ...
  public static String setRelationalPlaceholders(
      Player one, Player two, String text, boolean colorize) {
    if (text == null) {
      return null;
    }
  ...
  @Deprecated
  public static List<String> setBracketPlaceholders(
      Player player, List<String> text, boolean colorize) {
    return setPlaceholders(player, text, BRACKET_PLACEHOLDER_PATTERN, colorize);
  }
}
