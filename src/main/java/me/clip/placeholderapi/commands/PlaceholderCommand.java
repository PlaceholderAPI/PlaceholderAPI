...
public abstract class PlaceholderCommand {
  ...
  @NotNull
  public static Stream<PlaceholderCommand> filterByPermission(
      @NotNull final CommandSender sender, @NotNull final Stream<PlaceholderCommand> commands) {
  ...
  public static void suggestByParameter(
    ...
    if (parameter == null) {
      ...
      possible
          .filter(suggestion -> suggestion.toLowerCase().startsWith(parameter.toLowerCase()))
