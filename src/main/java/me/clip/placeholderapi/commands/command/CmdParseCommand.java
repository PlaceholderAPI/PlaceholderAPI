...
public final class CmdParseCommand extends Command {
    public CmdParseCommand() {
        super("cmdparse", options("&cYou must specify a player.", 1));
    }
    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        Bukkit.dispatchCommand(sender, PlaceholderAPI.setPlaceholders(player, parse));
    }
}
