        ...
        if (args.length == 0) {
            ...
            if (args[0].equalsIgnoreCase("help")) {
                ...
                if (args[0].equalsIgnoreCase("bcparse")) {
                    plugin.getServer().broadcast("&r" + PlaceholderAPI.setPlaceholders((OfflinePAPIPlayer) pl, parse), null);
                } else {
                    Msg.msg(s, "&r" + PlaceholderAPI.setPlaceholders((OfflinePAPIPlayer) pl, parse));
                }
